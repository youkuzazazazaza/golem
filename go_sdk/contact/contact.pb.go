...
type SelfInfo struct {
	...
	Uin           uint32                 `protobuf:"varint,5,opt,name=uin,proto3" json:"uin,omitempty"`          // UIN
...
func (x *SelfInfo) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *SelfInfo) GetNickname() string {
	if x != nil {
		return x.Nickname
	}
	return ""
...
func (x *SelfInfo) GetAlias() string {
	if x != nil {
		return x.Alias
	}
	return ""
...
func (x *SelfInfo) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *SelfInfo) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
func (x *GetSelf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSelf) ProtoMessage() {}

func (x *GetSelf) ProtoReflect() protoreflect.Message {
	mi := &file_contact_contact_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSelf.ProtoReflect.Descriptor instead.
func (*GetSelf) Descriptor() ([]byte, []int) {
...
func (x *GetSelf_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use GetSelf_Request.ProtoReflect.Descriptor instead.
func (*GetSelf_Request) Descriptor() ([]byte, []int) {
	return file_contact_contact_proto_rawDescGZIP(), []int{7, 0}
}

type GetSelf_Response struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Self          *SelfInfo              `protobuf:"bytes,1,opt,name=self,proto3,oneof" json:"self,omitempty"` // 当前登录账号信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSelf_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use GetSelf_Response.ProtoReflect.Descriptor instead.
func (*GetSelf_Response) Descriptor() ([]byte, []int) {
	return file_contact_contact_proto_rawDescGZIP(), []int{7, 1}
}

func (x *GetSelf_Response) GetSelf() *SelfInfo {
	if x != nil {
		return x.Self
	}
	return nil
...
func (*BlacklistRemove_Request) Descriptor() ([]byte, []int) {
	return file_contact_contact_proto_rawDescGZIP(), []int{13, 0}
}
...
func (*BlacklistRemove_Response) Descriptor() ([]byte, []int) {
	return file_contact_contact_proto_rawDescGZIP(), []int{13, 1}
}
...
func (*Search_Request) Descriptor() ([]byte, []int) {
	return file_contact_contact_proto_rawDescGZIP(), []int{14, 0}
}
...
func (*Search_Response) Descriptor() ([]byte, []int) {
	return file_contact_contact_proto_rawDescGZIP(), []int{14, 1}
}
...
const file_contact_contact_proto_rawDesc = "" +
	"\n" +
	"\x15contact/contact.proto\x12\acontact\"\xc6\x02\n" +
	"\aContact\x12\x1a\n" +
	...
	"\x03uin\x18\x05 \x01(\rR\x03uin\x12\x14\n" +
	"\x05email\x18\x06 \x01(\tR\x05email\x12\x16\n" +
	"\x06mobile\x18\a \x01(\tR\x06mobile\"k\n" +
	"\x03Get\x1a\x1b\n" +
	"\aRequest\x12\x10\n" +
	...
	"\aRequest\x1a8\n" +
	"\bResponse\x12,\n" +
	"\bcontacts\x18\x01 \x03(\v2\x10.contact.ContactR\bcontacts\"U\n" +
	"\aGetSelf\x1a\t\n" +
	"\aRequest\x1a?\n" +
	"\bResponse\x12*\n" +
	"\x04self\x18\x01 \x01(\v2\x11.contact.SelfInfoH\x00R\x04self\x88\x01\x01B\a\n" +
	"\x05_self\"\x84\x01\n" +
	"\tSetRemark\x1a=\n" +
	"\aRequest\x12\x1a\n" +
	...
	"\aGetSelf\x12\x18.contact.GetSelf.Request\x1a\x19.contact.GetSelf.Response\x12D\n" +
...
var file_contact_contact_proto_goTypes = []any{
	...
	(*SelfInfo)(nil),                 // 5: contact.SelfInfo
	(*Get)(nil),                      // 6: contact.Get
	(*List)(nil),                     // 7: contact.List
	(*GetSelf)(nil),                  // 8: contact.GetSelf
	(*SetRemark)(nil),                // 9: contact.SetRemark
	(*AddFriend)(nil),                // 10: contact.AddFriend
	(*VerifyFriend)(nil),             // 11: contact.VerifyFriend
	(*Delete)(nil),                   // 12: contact.Delete
